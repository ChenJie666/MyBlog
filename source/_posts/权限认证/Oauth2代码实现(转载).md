...
*   [听说你的JWT库用起来特别扭，推荐这款贼好用的！](https://mp.weixin.qq.com/s?__biz=MzU1Nzg4NjgyMw==&mid=2247485769&idx=1&sn=f032cf07e5104112f7a7187d9d254022&scene=21#wechat_redirect)
...
![启动服务.png](Oauth2代码实现(转载).assets\533ce89cd433408f9ed16efcfd03c319.png)

*  使用密码模式获取JWT令牌，访问地址：http://localhost:9201/auth/oauth/token
![获取JWT令牌.png](Oauth2代码实现(转载).assets\62966cae4dfc4f4abb430056e1417ade.png)

*  使用获取到的JWT令牌访问需要权限的接口，访问地址：http://localhost:9201/api/hello![访问权限接口.png](Oauth2代码实现(转载).assets\d664752b8c774a95ad687ca37a0c99a1.png)

*  使用获取到的JWT令牌访问获取当前登录用户信息的接口，访问地址: http://localhost:9201/api/user/currentUser
![访问用户接口.png](Oauth2代码实现(转载).assets\8e5b12e2880d435ca7a46978782e214e.png)

*  当JWT令牌过期时，使用refresh_token获取新的JWT令牌，访问地址：http://localhost:9201/auth/oauth/token
![刷新token.png](Oauth2代码实现(转载).assetscc96329f2a24d7d82bf827f2c159516.png)

*  使用没有访问权限的andy账号登录，访问接口时会返回如下信息，访问地址：http://localhost:9201/api/hello
![无权限访问](Oauth2代码实现(转载).assets\36654be4655849f7a13640faf12dd1b3.png)
